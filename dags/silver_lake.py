...
from shared.common.dag_defaults import SILVER_DEFAULTS, SPARK_SILVER_DEFAULTS
from shared.common.dag_factory import SilverDag, SparkSilverDag

from bronze_lake import bronze_assets

spark_default_args = SPARK_SILVER_DEFAULTS.copy()
silver_default_args = SILVER_DEFAULTS.copy()
...
with spark_silver.create_dag(
    ...
    default_args=spark_default_args
